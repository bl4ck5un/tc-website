# -*- coding: utf-8 -*-
#
# Town Crier: an Authenticated Data Feed for Smart Contracts documentation build configuration file, created by
...
project = u'Town Crier'
copyright = u'2017, Fan Zhang'
author = u'Fan Zhang'
